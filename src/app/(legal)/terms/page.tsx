            ...
            <div className="mx-auto max-w-3xl">
                ...
                <div className="bg-gray-50 rounded-2xl p-8 lg:p-12 border border-gray-200">
                    ...
                    <div className="space-y-6 text-gray-600 text-sm leading-relaxed">
                        ...
                        <section>
                            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">2. Description of Service</h2>
                            <p>VoiceFleet provides AI-powered voice agents that handle phone calls for businesses using artificial intelligence.</p>
                        </section>

                        <section>
                            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">3. User Responsibilities</h2>
                            <p className="font-semibold text-gray-900 mb-2">You are solely responsible for:</p>
                        ...
                        <section>
                            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">4. Prohibited Uses</h2>
                        ...
                        <section>
                            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">5. Payment and Billing</h2>
                        ...
                        <section>
                            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">6. Disclaimer of Warranties</h2>
                        ...
                        <section>
                            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">7. Limitation of Liability</h2>
                        ...
                        <section>
                            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">8. Termination</h2>
