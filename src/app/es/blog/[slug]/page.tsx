            ...
            <div className="flex flex-wrap items-center gap-6 text-indigo-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-200">Autor</p>
                </div>
              </div>
        ...
        <article className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="mt-12 p-8 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl border border-indigo-100">
            <h3 className="text-xl font-bold text-foreground mb-2">
              ¿Listo para probar VoiceFleet?
            </h3>
            <p className="text-muted-foreground mb-4">
              Descubrí cómo los agentes de voz IA pueden transformar tu negocio a un 80% menos de costo.
            </p>
