  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 lg:pt-20">
        ...
        <section className="py-16 bg-gradient-to-br from-blue-600 to-emerald-500">
          ...
          {pages.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {pages.map((page) => (
                ...
                >
                  <article className="bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border border-border h-full">
                    {page.hero_image_url && (
