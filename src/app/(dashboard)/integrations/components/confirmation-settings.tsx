          ...
          <CardContent className="p-6 space-y-4">
            ...
            <label className="flex items-center justify-between cursor-pointer p-3 rounded-lg hover:bg-slate-50 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-semibold text-slate-900">SMS Confirmation</span>
                  <p className="text-sm text-slate-500">Send booking details via text message</p>
                </div>
              </div>
              <div className="relative">
                ...
                <div
                  className={`w-12 h-6 rounded-full transition-colors ${
                    smsEnabled ? 'bg-primary' : 'bg-slate-200'
                  }`}
                >
                  <div
