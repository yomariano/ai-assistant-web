...
export default function MidPageCTA() {
  ...
  return (
    <section className="py-12 px-6">
      <div className="max-w-3xl mx-auto rounded-2xl border border-primary/20 bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <LiveDemoCall
            trigger={
              <button
                ...
                data-umami-event="midpage_cta_demo"
              >
                Try Live Demo
              </button>
            }
          ...
          {isArgentina && (
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 py-3 text-sm font-semibold text-white hover:bg-[#20bd5a] transition-colors"
              data-umami-event="midpage_cta_whatsapp"
            >
