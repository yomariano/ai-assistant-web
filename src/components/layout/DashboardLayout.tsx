...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const { isAuthenticated, isLoading, devMode, user, isHydrated, authError } = useAuthStore();
  ...
  }, [isHydrated, isLoading, isAuthenticated, authError, router]);
  ...
  // Show error screen if auth service is unreachable after retries
  if (authError) {
    return (
